...
const P31: Workout[] = [
    ...
    w('CIRCUIT B — UPPER BODY HIIT', 'Upper HIIT circuit.', HI, 'fat_loss', 50, [
        ...
        ex('Seated Dumbbell Shoulder Press', 5, '45s', 15), ex('Chin-Up (Max Reps)', 5, '45s', 15),
        ex('Battle Ropes', 5, '45s', 15), ex('Parallel Bar Dips', 5, '45s', 15),
        ex('EZ Bar Bicep Curl', 5, '45s', 15), ex('Treadmill HIIT', 1, '15 Min', 0, '1:1 Ratio'),
    ]),
...
const P32: Workout[] = [
    w('CIRCUIT A — MUSCLE GAIN HIIT', 'Compound HIIT for muscle.', HI, 'muscle_gain', 50, [
        ex('Barbell Back Squat', 5, '10', 90), ex('Flat Barbell Bench Press', 5, '10', 90),
        ex('Barbell Bent-Over Row', 5, '10', 90), ex('Barbell Overhead Press', 5, '8', 90),
        ex('Parallel Bar Dips', 5, 'Until Failure', 90, 'REST PAUSE on last set'),
    ]),
    w('CIRCUIT B — MUSCLE GAIN HIIT', 'Upper HIIT for muscle.', HI, 'muscle_gain', 50, [
        ex('Incline Dumbbell Press', 4, '12', 90), ex('Seated Cable Row', 4, '12', 90),
        ex('Seated Dumbbell Shoulder Press', 4, '12', 90), ex('Wide Grip Lat Pulldown', 4, '12', 90),
        ex('Cable Chest Fly', 4, '15', 60, 'REST PAUSE last'), ex('EZ Bar Bicep Curl', 4, '12', 60),
    ]),
    w('CIRCUIT C — MUSCLE GAIN HIIT', 'Lower HIIT for muscle.', HI, 'muscle_gain', 50, [
        ex('Leg Press', 5, '12', 90, 'REST PAUSE last'), ex('Romanian Deadlift', 4, '10', 90),
        ex('Leg Extension', 4, '12', 60, 'REST PAUSE'), ex('Leg Curl', 4, '12', 60, 'REST PAUSE'),
        ex('Standing Calf Raise', 5, '15', 60, 'REST PAUSE'), ex('Barbell Hip Thrust', 4, '12', 60),
    ]),
    w('CIRCUIT D — MUSCLE GAIN HIIT', 'Push HIIT for muscle.', HI, 'muscle_gain', 45, [
        ex('Flat Barbell Bench Press', 4, '10', 90), ex('Incline Hammer Strength Press', 4, '12', 90),
        ex('Seated Barbell Military Press', 4, '10', 90), ex('Dumbbell Lateral Raises', 4, '15', 60),
        ex('Cable Tricep Pushdown', 4, '12', 60), ex('Parallel Bar Dips', 3, 'Until Failure', 90),
    ]),
    w('CIRCUIT E — MUSCLE GAIN HIIT', 'Pull HIIT for muscle.', HI, 'muscle_gain', 45, [
        ex('Barbell Bent-Over Row', 4, '10', 90), ex('Wide Grip Lat Pulldown', 4, '12', 90),
        ex('T-Bar Row', 4, '10', 90), ex('Reverse Pec Deck (Rear Delt)', 4, '15', 60),
        ex('EZ Bar Bicep Curl', 4, '10', 60), ex('Barbell Shrugs', 4, '12', 60, 'REST PAUSE'),
    ]),
];

const P33: Workout[] = [
    w('CIRCUIT A — STRENGTH HIIT', 'Heavy barbell complex.', HI, 'strength', 55, [
        ex('Barbell Back Squat', 4, '5 @80%', 180), ex('Flat Barbell Bench Press', 4, '5 @80%', 180),
        ex('Barbell Bent-Over Row', 4, '5 @80%', 120), ex('Barbell Overhead Press', 3, '5', 120),
        ex('Deadlift', 3, '3 @85%', 240),
    ]),
    w('CIRCUIT B — STRENGTH HIIT', 'Upper strength circuit.', HI, 'strength', 50, [
        ex('Incline Barbell Bench Press', 4, '5-6', 180), ex('Weighted Chin-Up', 4, '5', 180),
        ex('Close Grip Barbell Bench Press', 3, '6', 120), ex('Barbell Bent-Over Row', 3, '5-6', 120),
        ex('EZ Bar Bicep Curl', 3, '6-8', 90),
    ]),
    w('CIRCUIT C — STRENGTH HIIT', 'Lower strength circuit.', HI, 'strength', 55, [
        ex('Barbell Front Squat', 4, '4-5', 180), ex('Conventional Deadlift', 4, '3', 240),
        ex('Hack Squat Machine', 3, '6-8', 120), ex('Barbell Good Morning', 3, '5', 120),
        ex('Nordic Hamstring Curl', 3, '5', 120),
    ]),
    w('CIRCUIT D — STRENGTH HIIT', 'Power circuit.', HI, 'strength', 50, [
        ex('Barbell Push Press', 4, '3', 180), ex('Barbell Power Clean', 4, '3', 180),
        ex('Barbell Box Squat', 4, '3', 180), ex('Weighted Parallel Bar Dips', 3, '5', 120),
        ex('Farmer\'s Walk', 3, '40m', 90),
    ]),
    w('CIRCUIT E — STRENGTH HIIT', 'Peaking circuit.', HI, 'strength', 45, [
        ex('Barbell Back Squat', 3, '2-3 @90%', 300), ex('Flat Barbell Bench Press', 3, '2-3 @90%', 300),
        ex('Deadlift', 3, '2 @92%', 300), ex('Barbell Overhead Press', 3, '3 @85%', 240),
    ]),
];

const P34: Workout[] = [
    w('CIRCUIT A — RECOMP HIIT', 'Paired compound circuit.', HI, 'recomp', 55, [
        ex('Barbell Back Squat', 4, 'S1×5, S2×10', 90), ex('Flat Barbell Bench Press', 4, 'S1×5, S2×10', 90),
        ex('Barbell Bent-Over Row', 4, 'S1×5, S2×10', 90), ex('Barbell Overhead Press', 3, 'S1×5, S2×10', 90),
        ex('Leg Curl', 3, '10-12', 60, 'REST PAUSE'), ex('Cable Chest Fly', 3, '12-15', 60),
    ]),
    w('CIRCUIT B — RECOMP HIIT', 'Upper recomp circuit.', HI, 'recomp', 50, [
        ex('Incline Dumbbell Press', 4, 'S1×6, S2×12', 90), ex('Seated Cable Row', 4, '10-12', 90),
        ex('Seated Dumbbell Shoulder Press', 3, '8-12', 90), ex('Wide Grip Lat Pulldown', 3, '10-12', 90),
        ex('EZ Bar Bicep Curl', 3, '10-12', 60), ex('Cable Tricep Pushdown', 3, '12', 60),
    ]),
    w('CIRCUIT C — RECOMP HIIT', 'Lower recomp circuit.', HI, 'recomp', 50, [
        ex('Hack Squat Machine', 4, 'S1×6, S2×12', 90), ex('Romanian Deadlift', 4, 'S1×5, S2×10', 90),
        ex('Leg Extension', 3, '12-15', 60, 'REST PAUSE'), ex('Leg Curl', 3, '12-15', 60, 'REST PAUSE'),
        ex('Standing Calf Raise', 4, '15', 60), ex('Barbell Hip Thrust', 3, '12', 60),
    ]),
    w('CIRCUIT D — RECOMP HIIT', 'Push recomp circuit.', HI, 'recomp', 45, [
        ex('Flat Barbell Bench Press', 4, '8-12', 90), ex('Incline Hammer Strength Press', 3, '10-12', 90),
        ex('Barbell Overhead Press', 3, '8-10', 90), ex('Dumbbell Lateral Raises', 4, '15', 60),
        ex('Parallel Bar Dips', 3, 'Until Failure', 60),
    ]),
    w('CIRCUIT E — RECOMP HIIT', 'Pull recomp circuit.', HI, 'recomp', 45, [
        ex('T-Bar Row', 4, '8-10', 90), ex('Wide Grip Lat Pulldown', 4, '10-12', 90),
        ex('Reverse Pec Deck (Rear Delt)', 3, '15', 60), ex('Barbell Shrugs', 3, '12', 60, 'REST PAUSE'),
        ex('EZ Bar Bicep Curl', 3, '10-12', 60),
    ]),
];
...
const P35: Workout[] = [
    w('CIRCUIT A — MAINTENANCE HIIT', 'Balanced circuit.', HI, 'maintenance', 40, [
        ...
        ex('DB Row', 3, '12 Each', 0), ex('Dumbbell Chest Press', 3, '12', 0),
        ex('Dumbbell Lateral Raises', 3, '15', 0), ex('Plank', 3, '45s', 120),
    ]),
    w('CIRCUIT B — MAINTENANCE HIIT', 'Upper maintenance circuit.', HI, 'maintenance', 35, [
        ex('Dumbbell Chest Press', 3, '12', 90), ex('Seated Cable Row', 3, '12', 90),
        ex('Seated Dumbbell Shoulder Press', 3, '12', 90), ex('Wide Grip Lat Pulldown', 3, '12', 90),
        ex('EZ Bar Bicep Curl', 3, '12', 60), ex('Cable Tricep Pushdown', 3, '12', 60),
    ]),
    w('CIRCUIT C — MAINTENANCE HIIT', 'Lower maintenance circuit.', HI, 'maintenance', 35, [
        ...
        ex('Barbell Hip Thrust', 3, '12', 60), ex('Core Circuit (Plank / Crunch / Leg Raise)', 3, 'Circuit', 30),
    ]),
    w('CIRCUIT D — MAINTENANCE HIIT', 'Full body maintenance.', HI, 'maintenance', 35, [
        ex('Barbell Back Squat', 3, '10', 90), ex('Flat Barbell Bench Press', 3, '10', 90),
        ex('Barbell Bent-Over Row', 3, '10', 90), ex('Barbell Overhead Press', 3, '10', 90),
    ]),
    w('CIRCUIT E — MAINTENANCE HIIT', 'Light circuit.', HI, 'maintenance', 30, [
        ex('DB Squat', 3, '12', 90), ex('Push-Up', 3, 'Max', 30),
        ex('DB Row', 3, '12 Each', 90), ex('Dumbbell Lateral Raises', 3, '15', 60),
        ex('Plank', 3, '30s', 30),
    ]),
];
...
const P36: Workout[] = [
    ...
    w('CIRCUIT B — ENDURANCE HIIT', 'Upper endurance circuit.', HI, 'endurance', 50, [
        ...
        ex('Cable Chest Fly', 5, '45s', 15), ex('Curl + Triceps SS', 5, '45s', 15),
    ]),
    w('CIRCUIT C — ENDURANCE HIIT', 'Lower endurance circuit.', HI, 'endurance', 50, [
        ...
        ex('Standing Calf Raise', 5, '45s', 15), ex('Squat Jump', 5, '45s', 15),
    ]),
    w('CIRCUIT D — ENDURANCE HIIT', 'Full body AMRaP.', HI, 'endurance', 45, [
        ex('Goblet Squat', 5, '20', 15), ex('Push-Up', 5, 'Max', 15),
        ex('DB Row', 5, '15 Each', 15), ex('Barbell Overhead Press', 5, '15', 15),
...
const P37: Workout[] = [
    ...
    w('CARDIO B — FAT LOSS', 'Bike HIIT + light weights.', CA, 'fat_loss', 50, [
        ex('Bike: Sprint / Easy', 1, '20 Min 30s/90s', 0), ex('Seated Dumbbell Shoulder Press', 3, '20', 30),
        ex('Dumbbell Lateral Raises', 3, '25', 30), ex('Push-Ups', 3, 'Max', 30),
        ex('Cable Chest Fly', 3, '20', 30), ex('Cable Tricep Pushdown', 3, '20', 30),
    ...
    w('CARDIO D — FAT LOSS', 'Stairmaster + legs.', CA, 'fat_loss', 50, [
        ...
        ex('Leg Curl', 3, '25', 30), ex('Barbell Hip Thrust', 3, '20', 30),
        ex('Standing Calf Raise', 5, '25', 30), ex('Core Circuit', 4, '20 Reps Each', 15),
    ]),
...
const P38: Workout[] = [
    w('CARDIO A — MUSCLE GAIN', 'Zone 2 + Push.', CA, 'muscle_gain', 55, [
        ex('Zone 2 Cardio Warm-Up', 1, '20 Min Easy', 0), ex('Incline Dumbbell Press', 4, '8-12', 120),
        ex('Cable Chest Fly', 3, '12-15', 60), ex('Seated Barbell Military Press', 4, '8-10', 120),
        ex('Dumbbell Lateral Raises', 4, '12-15', 60), ex('Cable Tricep Pushdown', 3, '12', 60),
    ]),
    w('CARDIO B — MUSCLE GAIN', 'Zone 2 + Pull.', CA, 'muscle_gain', 55, [
        ex('Zone 2 Cardio Warm-Up', 1, '20 Min Easy', 0), ex('Barbell Bent-Over Row', 4, '8-10', 120),
        ex('Wide Grip Lat Pulldown', 4, '10-12', 90), ex('Seated Cable Row', 3, '12', 90),
        ex('Reverse Pec Deck (Rear Delt)', 3, '15', 60), ex('EZ Bar Bicep Curl', 3, '10-12', 60),
    ]),
    ...
    w('CARDIO D — MUSCLE GAIN', 'Zone 2 + Upper.', CA, 'muscle_gain', 55, [
        ex('Zone 2 Cardio Warm-Up', 1, '20 Min Easy', 0), ex('Flat Barbell Bench Press', 4, '8-12', 120),
        ex('T-Bar Row', 4, '8-10', 120), ex('Seated Dumbbell Shoulder Press', 3, '10-12', 90),
        ex('Pec Deck Fly', 3, '12-15', 60), ex('Barbell Shrugs', 3, '12', 60),
    ]),
    w('CARDIO E — MUSCLE GAIN', 'Zone 2 + Push B.', CA, 'muscle_gain', 50, [
        ex('Zone 2 Cardio Warm-Up', 1, '20 Min Easy', 0), ex('Incline Hammer Strength Press', 4, '10-12', 90),
        ex('Standing Cable Chest Fly', 3, '12-15', 60), ex('Barbell Overhead Press', 3, '10', 90),
        ex('Dumbbell Concentration Curl', 3, '12', 60), ex('Parallel Bar Dips', 3, 'Until Failure', 60),
    ]),
    w('CARDIO F — MUSCLE GAIN', 'Zone 2 + Pull B.', CA, 'muscle_gain', 50, [
        ex('Zone 2 Cardio Warm-Up', 1, '20 Min Easy', 0), ex('Wide Grip Lat Pulldown', 4, '10-12', 90),
        ex('Chest-Supported Dumbbell Row', 3, '12', 90), ex('Bent-Over Dumbbell Lateral Raise', 3, '15', 60),
...
const P39: Workout[] = [
    w('CARDIO A — STRENGTH', 'Easy bike + squat.', CA, 'strength', 50, [
        ex('Low Intensity Cardio Warm-Up', 1, '15 Min', 0), ex('Barbell Back Squat', 5, '5 @80%', 240),
        ex('Barbell Front Squat', 3, '5', 180), ex('Leg Press', 2, '8', 90),
    ]),
    w('CARDIO B — STRENGTH', 'Easy bike + bench.', CA, 'strength', 45, [
        ex('Low Intensity Cardio Warm-Up', 1, '15 Min', 0), ex('Flat Barbell Bench Press', 5, '5 @80%', 240),
        ex('Close Grip Barbell Bench Press', 3, '6', 120), ex('Incline Dumbbell Press', 3, '6-8', 90),
    ]),
    w('CARDIO C — STRENGTH', 'Easy bike + deadlift.', CA, 'strength', 50, [
        ex('Low Intensity Cardio Warm-Up', 1, '15 Min', 0), ex('Deadlift', 4, '3 @85%', 300),
        ex('Barbell Bent-Over Row', 3, '5', 120), ex('Barbell Good Morning', 3, '5', 90),
    ]),
    w('CARDIO D — STRENGTH', 'Zone 2 recovery.', CA, 'strength', 40, [
        ex('Zone 2 Steady State Cardio', 1, '30-40 Min', 0, 'Recovery only'),
    ]),
    w('CARDIO E — STRENGTH', 'Easy bike + OHP.', CA, 'strength', 45, [
        ex('Low Intensity Cardio Warm-Up', 1, '15 Min', 0), ex('Barbell Overhead Press', 5, '5 @80%', 240),
        ex('Seated Dumbbell Shoulder Press', 3, '5-6', 120), ex('Dumbbell Lateral Raises', 3, '12', 60),
    ]),
...
const P40: Workout[] = [
    w('CARDIO A — RECOMP', 'HIIT + Push recomp.', CA, 'recomp', 55, [
        ex('HIIT Intervals', 1, '20 Min 30s/60s', 0), ex('Incline Dumbbell Press', 4, 'S1×6, S2×12', 90),
        ex('Cable Chest Fly', 3, '12-15', 60), ex('Seated Press', 3, 'S1×6, S2×12', 90),
        ex('Dumbbell Lateral Raises', 4, '15', 60),
    ]),
    w('CARDIO B — RECOMP', 'HIIT + Pull recomp.', CA, 'recomp', 55, [
        ex('HIIT Intervals', 1, '20 Min 30s/60s', 0), ex('Barbell Bent-Over Row', 4, 'S1×6, S2×12', 90),
        ex('Wide Grip Lat Pulldown', 3, '10-12', 90), ex('Seated Cable Row', 3, '12', 60),
        ex('EZ Bar Bicep Curl', 3, '10-12', 60), ex('Barbell Shrugs', 3, '12', 60),
    ]),
    w('CARDIO C — RECOMP', 'HIIT + Legs recomp.', CA, 'recomp', 55, [
        ex('HIIT Intervals', 1, '20 Min 30s/60s', 0), ex('Hack Squat Machine', 4, 'S1×6, S2×12', 90),
        ex('Leg Extension', 3, '12-15', 60, 'REST PAUSE'), ex('Leg Curl', 3, '12', 60, 'REST PAUSE'),
        ex('Standing Calf Raise', 4, '15', 60), ex('Barbell Hip Thrust', 3, '12', 60),
    ]),
    w('CARDIO D — RECOMP', 'HIIT + Upper recomp.', CA, 'recomp', 50, [
        ex('HIIT Intervals', 1, '20 Min 30s/60s', 0), ex('Flat Barbell Bench Press', 4, 'S1×5, S2×10', 90),
        ex('T-Bar Row', 3, '8-10', 90), ex('Pec Deck Fly', 3, '12-15', 60),
        ex('Reverse Pec Deck (Rear Delt)', 3, '15', 60),
    ]),
    w('CARDIO E — RECOMP', 'HIIT + Push B recomp.', CA, 'recomp', 50, [
        ex('HIIT Intervals', 1, '20 Min 30s/60s', 0), ex('Incline Hammer Strength Press', 4, '8-12', 90),
        ex('Standing Cable Chest Fly', 3, '12-15', 60), ex('Seated Dumbbell Shoulder Press', 3, '10-12', 60),
        ex('Cable Tricep Pushdown', 3, '12', 60),
    ]),
    w('CARDIO F — RECOMP', 'HIIT + Pull B recomp.', CA, 'recomp', 50, [
        ex('HIIT Intervals', 1, '20 Min 30s/60s', 0), ex('Wide Grip Lat Pulldown', 4, '10-12', 90),
        ex('Chest-Supported Dumbbell Row', 3, '12', 60), ex('Bent-Over Dumbbell Lateral Raise', 3, '15', 60),
...
const P41: Workout[] = [
    w('CARDIO A — MAINTENANCE', 'Steady state.', CA, 'maintenance', 40, [
        ex('Moderate Steady State Cardio', 1, '30-40 Min', 0, 'Conversational pace'),
    ]),
    w('CARDIO B — MAINTENANCE', 'Steady + light.', CA, 'maintenance', 45, [
        ex('Moderate Steady State Cardio', 1, '30 Min', 0), ex('Push-Ups', 3, '12', 60),
        ex('DB Row', 3, '12 Each', 60), ex('Plank', 3, '30s', 30),
    ]),
    w('CARDIO C — MAINTENANCE', 'Steady state B.', CA, 'maintenance', 40, [
        ex('Moderate Steady State Cardio', 1, '30-40 Min', 0, 'Comfortable pace'),
    ]),
    w('CARDIO D — MAINTENANCE', 'Walk + light legs.', CA, 'maintenance', 45, [
        ex('Moderate Steady State Cardio', 1, '30 Min', 0), ex('Goblet Squat', 3, '12', 60),
        ex('Leg Extension', 3, '12', 60), ex('Standing Calf Raise', 3, '15', 30),
    ]),
    w('CARDIO E — MAINTENANCE', 'Steady state C.', CA, 'maintenance', 35, [
        ex('Moderate Steady State Cardio', 1, '30 Min', 0, 'Conversational pace'),
    ]),
    w('CARDIO F — MAINTENANCE', 'Light active.', CA, 'maintenance', 40, [
        ex('Low Intensity Steady State Cardio', 1, '30 Min', 0), ex('Mobility Work', 1, '10 Min', 0),
    ]),
];

const P42: Workout[] = [
    w('CARDIO A — ENDURANCE', 'Long Zone 2-3.', CA, 'endurance', 75, [
        ex('Zone 2-3 Sustained Cardio', 1, '60-90 Min', 0, 'Progressive distance'),
    ]),
