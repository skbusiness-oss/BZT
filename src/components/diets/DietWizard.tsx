...
export const DietWizard = ({ onClose, onAssigned }: Props) => {
    ...
    return (
        ...
        >
            <div className="bzt-rise-in max-w-xl w-full rounded-3xl bg-surface-container-low border border-outline-variant/30 overflow-hidden max-h-[92vh] flex flex-col">
                {/* Header */}
